...
* @date 2020-01-02
*/
@Api(tags = "数据库中间件：文档管理(按月存储")
@RestController
@RequestMapping("/api/yearmonthcontent")
public class YearMonthContentController {

    private final DeptsService DeptsService;

	private final ContentIdsService ContentIdsService;

    public YearMonthContentController(DeptsService DeptsService, ContentIdsService ContentIdsService) {
