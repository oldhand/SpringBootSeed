...
//* @date 2020-01-02
//*/
//@Api(tags = "数据库中间件：文档管理(按年存储)")
//@RestController
//@RequestMapping("/api/yearcontent")
//public class YearContentController {
//
//    private final DeptsService DeptsService;
//
//	private final ContentIdsService ContentIdsService;
//
//    public YearContentController(DeptsService DeptsService, ContentIdsService ContentIdsService) {
