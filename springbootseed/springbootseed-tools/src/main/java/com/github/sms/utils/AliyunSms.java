...
public class AliyunSms {
    ...
    public static SendSmsResponse send(String mobile,String regioncode,String verifycode) throws ClientException {
        ...
        request.setTemplateParam("{\"" + codename+ "\":\"" + verifycode + "\"}");
